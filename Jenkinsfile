pipeline {
    ...
    environment {
    REGISTRY_NAME = "akscloud"
    ACR_LOGIN_SERVER = "${REGISTRY_NAME}.azurecr.io"
    REPOSITORY_NAME = "shopping-cart"
    AZURE_CREDENTIALS_ID = credentials('azure-sp-credentials')  // Change to your credentials ID
    AKS_RESOURCE_GROUP = 'cloud-shell-storage-southeastasia'
    AKS_CLUSTER_NAME = 'akscloud'
    AZURE_SP_TENANT ='2dff09ac-2b3b-4182-9953-2b548e0d0b39'
    }
